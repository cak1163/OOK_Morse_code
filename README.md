...
3. Decode the incoming pulses into a Morse code and ASCII letter sequence using [python code/morse_generator_and_decoder.py](python code/morse_generator_and_decoder.py)
